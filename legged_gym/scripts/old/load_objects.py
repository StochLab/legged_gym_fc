...
#
# # load ball asset
# ball_root = "/home/vamshi/packages/IsaacGym_Preview_4_Package/isaacgym/assets"
# ball_file = "urdf/ball.urdf"
# ball_asset = gym.load_asset(sim, ball_root, ball_file, gymapi.AssetOptions())
#
# robot_root = '/home/vamshi/Downloads/legged_gym-libtraj/resources/robots/stoch3'
# robot_file = "urdf/stoch3_dynamicWeight.urdf"
# # robot_asset = gym.load_asset(sim, robot_root, robot_file, gymapi.AssetOptions())
#
# # set up the env grid
...
#         collision_filter = 0
#
#     ball_handle = gym.create_actor(env, ball_asset, pose, "ball",
#                                    collision_group, collision_filter)
#     gym.set_rigid_body_color(env, ball_handle, 0,
#                              gymapi.MESH_VISUAL_AND_COLLISION, color)
#
#     # robot_handle = gymapi.create_actor(env, robot_asset, pose, "robot",
#     #                                      0, 0, 0)
#
...
# load ball asset
asset_root = "/home/vamshi/packages/IsaacGym_Preview_4_Package/isaacgym/assets"
...
for i in range(num_envs):
    ...
    robot_pose.p = gymapi.Vec3(0.0, 0.0, 0.45)
