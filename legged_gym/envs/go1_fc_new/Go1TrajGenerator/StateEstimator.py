...
class StateEstimator:
    ...
    def getContactPhase(self):
        return self._contactPhase.flatten()
    ...
    def update(self, body_states):
        ...
        # print("Normal: ")
        # print("vBody: ", self.result.vBody)
        # print('rBody: ', self.result.rBody)
        # print("omegaBody: ", self.result.omegaBody)
        # print("rpy: ", self.result.rpy)
        # print('ground R body frame: ', self.ground_R_body_frame)
        # print('rpyBody: ', self.result.rpyBody)
